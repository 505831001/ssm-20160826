...
<%@ taglib prefix="wei" uri="http://liuweiwei.com/common" %>
<%
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Spring Boot - 客户管理系统 v2.0</a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li>
                        <a href="#">
                            <i class="fa fa-gear fa-fw"></i>系统设置
                        </a>
                    </li>
                    <li class="divider"></li>
                    <li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<%=basePath%>customer/manager.wei" class="active">
                            <i class="fa fa-edit fa-fw"></i>客户管理
                        </a>
                    </li>
                    <li>
                        <a href="<%=basePath%>customer/visit.wei">
    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <!-- http://localhost:8080/customer/list.action -->
                <form class="form-inline" action="${pageContext.request.contextPath }/customer/list.wei" method="get">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <wei:page url="${pageContext.request.contextPath }/customer/list.wei" />
                        <!-- /.page -->
                    </div>
                    <!-- /.panel-body -->
                </div>
...
<script type="text/javascript">
    function editCustomer(id) {
        $.ajax({
            type: "get",
            url: "<%=basePath%>customer/detail.wei",
            data: {"id": id},
    ...
    function updateCustomer() {
        $.post("<%=basePath%>customer/update.wei", $("#edit_customer_form").serialize(), function (data) {
            alert("客户信息更新成功！");
    ...
    function deleteCustomer(id) {
        if (confirm('确实要删除该客户吗?')) {
            $.post("<%=basePath%>customer/delete.wei", {"id": id}, function (data) {
                alert("客户删除更新成功！");
                window.location.reload();
            });
        }
